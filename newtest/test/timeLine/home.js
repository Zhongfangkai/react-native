...
class Home extends React.Component {
  ...
  renderHeaderItem(data){
    return (
      <View style={{flexDirection:'row',height:75}}>
          <View>
              <Image source={require('./b.png')} style={{width:20,height:20,marginLeft:10,flex:1}}/>
          </View>
          <View >
              <View style={{height:5}}/>
  ...
  renderCenterItem(data){
    return (
      <View style={{flexDirection:'row',height:75}}>
          <View>
              <Image source={require('./b.png')} style={{marginLeft:25,flex:1}}/>

              <Image source={require('./b.png')} style={{marginLeft:25,flex:1}}/>
          </View>
          <View >
              <View style={{height:5}}/>
              <Image source={require('./l.png')}
  ...
  renderFooterItem(data){
    return (
      <View style={{flexDirection:'row',height:75}}>
          <View>
              <Image source={require('./a.png')} style={{height:20,marginLeft:25}}/>
              <Image source={require('./a.png')} style={{width:30,height:30,marginLeft:10}}/>
          </View>
          <View >
              <View style={{height:5}}/>
